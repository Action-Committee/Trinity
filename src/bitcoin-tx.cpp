...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Trinity Core trinity-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  trinity-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded trinity transaction") + "\n" +
              "  trinity-tx [options] -create [commands]   " + _("Create hex-encoded trinity transaction") + "\n" +
              "\n";
