...
static const unsigned int MAX_STANDARD_TX_SIZE = DEFAULT_BLOCK_MAX_SIZE/10;
...
/** Trinity: Dust Threshold: outputs below this value in satoshis are assessed an additional 1000 bytes per txout */
static const CAmount DUST_THRESHOLD = CENT; // 0.00000001 TTY
/** Trinity: Default TX Fee per 1000 bytes */
static const CAmount DEFAULT_TX_FEE = 20000; // 0.0002 TTY

/** Trinity: default minimum input threshold, override with -mininput */
