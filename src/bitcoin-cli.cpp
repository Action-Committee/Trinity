...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  trinity-cli [options] <command> [params]  " + _("Send command to Trinity Core") + "\n" +
                  "  trinity-cli [options] help                " + _("List commands") + "\n" +
                  "  trinity-cli [options] help <command>      " + _("Get help for a command") + "\n";
