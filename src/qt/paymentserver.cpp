...
const char* BIP71_MIMETYPE_PAYMENT = "application/trinity-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/trinity-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/trinity-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start trinity: click-to-pay handler"));
        }
        else {
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                emit message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Trinity address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
