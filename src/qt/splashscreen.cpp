    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int paddingRight            = 213;
    int paddingRightCopyright   = 319;
    int paddingTop              = 200;
    int paddingCopyrightTop     = -186;
    ...
    QString copyrightText2   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Trinity Core developers"));
