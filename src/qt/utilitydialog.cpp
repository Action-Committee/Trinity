    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Trinity Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Trinity Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Trinity Core is shutting down...") + "<br /><br />" +
