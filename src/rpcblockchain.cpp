...
double GetDifficulty(const CBlockIndex* blockindex, int algo)
{
    ...
    if (blockindex == NULL)
    {
        ...
        {
            blockindex = chainActive.GetLastBlockIndexForAlgo(chainActive.Tip(), algo);
            if (blockindex == NULL)
                return 1.0;
        }
    }
...
Value getrawmempool(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in trinitys\n"
...
Value gettxout(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of trinity addresses\n"
